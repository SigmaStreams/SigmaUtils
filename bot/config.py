...
# SS VOD role automation
SS_VOD_ROLE_ID = int(os.getenv("SS_VOD_ROLE_ID", os.getenv("ACTIVE_SUBSCRIBER_ROLE_ID", "0"))) or None
EXPIRED_ROLE_ID = int(os.getenv("EXPIRED_ROLE_ID", "0")) or None
SS_VOD_ROLE_SYNC_DELAY_SECONDS = 5
